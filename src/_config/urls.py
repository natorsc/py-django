...
urlpatterns = [
    ...
    path(
        route='sitemap.xml',
        view=cache_page(60 * 15, key_prefix='sitemap')(sitemaps_views.index),
        # kwargs={'sitemaps': apps_sitemap, 'sitemap_url_name': 'sitemaps'},
        kwargs={'sitemaps': apps_sitemap},
        name='django.contrib.sitemaps.views.index',
    ),
    path(
        route='sitemap-<section>.xml',
        view=cache_page(60 * 15, key_prefix='sitemap-section')(
